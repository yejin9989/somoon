...
height:40px;
width: 32px;
background: url(https://somoonhouse.com/img/search_btn.png) no-repeat;
border: none;
}
.btn{
height:33px;
...
#ref::before{
	content: ;
    background-image: url(https://somoonhouse.com/img/thumbs.png);
...
input#search {
    background: url(https://somoonhouse.com/img/search_btn.png);
