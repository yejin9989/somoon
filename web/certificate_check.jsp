...
//세션 가져오기 get session
    ...
    query = "select * from COMPANY_CERTIFICATE";
...
<%!
    public class Company{
        ...
        String state_str;
        String reason;
        public Company(String company_id, String apply_id, String name, String certificate_img, String state, String state_str, String reason){
        ...
        public void updateStateReason(){
            try{
                ...
                String c_sql = "UPDATE COMPANY_CERTIFICATE SET Status = ?, Reason = ? ";
...
<%
    ...
    while(rs.next()){ //BL : Business License
        ...
        String company_name = "";
        String certificate_img = rs.getString("Certificate_img");
        ...
        Company temp_company = new Company(company_id, apply_id, company_name, certificate_img, state, state_str, reason);
...
<div id="container">
    ...
    <div class="blank" id="blank<%=com.getApplyId()%>">
        ...
        <div class="license-img-area" style="background:url('<%=com.getCertificateImg()%>');background-size:300px 400px;"></div>
