...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/company_add.css"/>
    <meta charset="UTF-8">
...
<div id="container">
    ...
    <div id="main">
        <form action="_company_add.jsp" method="post">
            <h3>새 회사 등록</h3>
            <input name="name" type="text" placeholder="회사 이름">
            <input name="address" type="text" placeholder="회사 주소">
            <input name="introduction" type="text" placeholder="회사 소개글">
            <input name="phone" type="text" placeholder="연락받을 번호 -포함">
            <input name="pw" id="pw" type="password" placeholder="비밀번호">
            <input id="pw_ck" type="password" placeholder="비밀번호확인">
            <div id="check_pw">비밀번호가 일치하지 않습니다</div>
...
<script>
    $("#pw_ck").on("propertychange change keyup paste input", function() {
        var original = $("#pw").val();
        var check = $(this).val();
        if(original == check) {
